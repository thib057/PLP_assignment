...
public class Mapper2 extends Mapper<LongWritable, Text, Text, CompositeTwoELements> {
	...
	protected void map(LongWritable keyE, Text valE, Context context) throws IOException,InterruptedException
	    {
			...
			Text docId = new Text(attributes[1]);
			String wc = attributes[2]; //wordcount value
			String word = attributes[0];

			CompositeTwoELements compValue = new CompositeTwoELements(word, wc);
